...
### Kratko tekstualno objašnjenje
Ovaj sequence dijagram prikazuje scenarij prijave studenta na termin. Student putem korisničkog sučelja šalje zahtjev za prijavu. Sustav prvo provjerava je li korisnik autentificiran. Ako nije, korisniku se prikazuje poruka o potrebi prijave u sustav. Ako je autentificiran, sustav dohvaća podatke o terminu iz baze podataka i provjerava dostupnost mjesta. Ako ima slobodnih mjesta, prijava se sprema i korisnik dobiva potvrdu. U suprotnom, sustav vraća poruku o nedostatku mjesta.
